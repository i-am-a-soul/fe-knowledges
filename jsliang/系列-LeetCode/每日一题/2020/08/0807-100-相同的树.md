...
> Create by **jsliang** on **2020-08-07 10:09:07**  
> Recently revised in **2020-08-07 10:22:14**
 ...
 * @return {boolean}
 */
const isSameTree = (root1, root2) => JSON.stringify(root1) === JSON.stringify(root2);
...
直接用 `JSON.stringify` 化成字符串，然后一行求解。
