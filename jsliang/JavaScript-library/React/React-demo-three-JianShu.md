...
| [一 目录](#chapter-one) | 
| [二 前言](#chapter-two) |
| [三 初始化项目目录](#chapter-three) |
| [四 创建 React 头部组件](#chapter-four) |
| [五 编写简书头部导航](#chapter-five) |
| [六 设置输入框动画](#chapter-six) |
| [七 优化代码](#chapter-seven) |
| [八 使用 redux-devtools-extension 插件](#chapter-eight) |
| [九 优化：抽取 reducer.js](#chapter-night) |
| [十 优化：抽取 action](#chapter-ten) |
| [十一 优化：immutable.js](#chapter-eleven) |
| [十二 优化：redux-immutable](#chapter-twelve) |
| [十三 功能实现：热门搜索](#chapter-thirteen) |
| [十四 代码优化](#chapter-fourteen) |
| [十五 解决历史遗留问题](#chapter-fifteen) |
| [十六 功能实现：换一换](#chapter-sixteen) |
| [十七 功能优化](#chapter-seventeen) |
| &emsp;[17.1 换一换图标旋转](#chapter-seventeen-one) |
| &emsp;[17.2 避免聚焦重复请求](#chapter-seventeen-two) |
| [十八 React 路由](#chapter-eighteen) |
| &emsp;[18.1 路由（一）](#chapter-eighteen-one) |
| &emsp;[18.2 路由（二）](#chapter-eighteen-two) |
| [十九 页面实现：二级导航栏](#chapter-nighteen) |
| [二十 页面实现：首页](#chapter-twenty) |
| &emsp;[20.1 多层级组件引用 store](#chapter-twenty-one) |
| &emsp;[20.2 完善整个首页](#chapter-twenty-two) |
| [二十一 总结](#chapter-twentyone) |
