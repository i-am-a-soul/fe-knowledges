...
| [一 目录](#chapter-one) | 
| [二 前言](#chapter-two) |
| [三 初始化项目](#chapter-three) |
| [四 使用 Ant Design](#chapter-four) |
| [五 使用 Redux](#chapter-five) |
| [六 Redux 探索](#chapter-six) |
| &emsp;[6.1 Redux 插件](#chapter-six-one) |
| &emsp;[6.2 Redux 知识点讲解](#chapter-six-two) |
| [七 Redux 探索](#chapter-seven) |
| &emsp;[7.1 Input 输入数据](#chapter-seven-one) |
| &emsp;[7.2 Button 提交数据](#chapter-seven-two) |
| &emsp;[7.3 删除 TodoItem 列表项](#chapter-seven-three) |
| [八 优化：抽取 ActionType](#chapter-eight) |
| [九 优化：抽取整个 action](#chapter-night) |
| [十 优化：UI 组件和容器组件](#chapter-ten) |
| [十一 优化：无状态组件](#chapter-eleven) |
| [十二 结尾：调用 Axios，Redux-Base 完成](#chapter-twelve) |
| [十三 进阶：Redux 中间件](#chapter-thirteen) |
| [十四 进阶：Redux-Thunk 中间件进行 ajax 请求管理](#chapter-fourteen) |
| [十五 进阶：Redux-Saga 中间件进行 Ajax 请求管理](#chapter-fifteen) |
| [十六 进阶：React-Redux](#chapter-sixteen) |
