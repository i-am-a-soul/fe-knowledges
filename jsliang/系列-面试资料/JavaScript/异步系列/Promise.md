...
| [六 题库：结合 setTimeout](#chapter-six) |
...
| [七 .then() 链式操作](#chapter-seven) |
| &emsp;[7.1 两个参数](#chapter-seven-one) |
| &emsp;[7.2 链式调用](#chapter-seven-two) |
| [八 .catch() 捕获问题](#chapter-eight) |
| [九 .finally() 强制执行](#chapter-night) |
| [十 题库：.then()、.catch()、.finally()](#chapter-ten) |
...
| [十一 .all() 接力赛](#chapter-eleven) |
| [十二 .race() 个人赛](#chapter-twelve) |
| [十三 题库：.all()、.race()](#chapter-thirteen) |
...
| [十四 Promise 源码](#chapter-fourteen) |
| [十五 题库：结合 async/await](#chapter-fifteen) |
...
### 17.1 使用 Promise 实现每隔一秒输出 1、2、3
