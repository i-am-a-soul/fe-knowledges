...
| &emsp;[3.9 搜索框](#chapter-three-night)                                   | 2   |
| &emsp;&emsp;[3.9.1 margin-top 无法上浮](#chapter-three-night-one)                                                                                     |     |
| &emsp;&emsp;[3.9.2 改造 WeUI 搜索框](#chapter-three-night-two)                                                                                        |     |
| &emsp;[3.10 微信小程序分享](#chapter-three-ten)                                | 1   |
| &emsp;[3.11 border-box 设置](#chapter-three-eleven)                      | 1   |
| &emsp;[3.12 自定义导航条](#chapter-three-twelve)                         | 6   |
...
| &emsp;[3.15 诡异的 open-type](#chapter-three-fifteen)                  | 1   |
| &emsp;[3.16 \<button\>去样式及其内嵌\<image\>](#chapter-three-sixteen) | 1   |
| &emsp;[3.17 下拉刷新和上拉加载](#chapter-three-seventeen)          | 2   |
| &emsp;[3.18 获取 input 的值](#chapter-three-eighteen)                | 1   |
| &emsp;[3.19 onLaunch 加载问题](#chapter-three-nighteen)              | 2   |
| &emsp;&emsp;[3.19.1 小程序执行顺序](#chapter-three-nighteen-one)                                                                                      |     |
| &emsp;&emsp;[3.19.2 路由守卫](#chapter-three-nighteen-two)                                                                                            |     |
| &emsp;[3.20 request 封装与 api 抽离](#chapter-three-twenty)              | 1   |
| &emsp;[3.21 判断数据是否读取完](#chapter-three-twenty-one)       | 1   |
| &emsp;[3.22 客服系统研究](#chapter-three-twenty-two)             | 1   |
| &emsp;[3.23 文件在线预览](#chapter-three-twenty-three)       | 2   |
| &emsp;[3.24 尽量使用 ES6](#chapter-three-twenty-four)          | 1   |
| &emsp;[3.25 视频功能实现](#chapter-three-twenty-five)          | 1   |
| &emsp;[3.26 多层 for 循环](#chapter-three-twenty-six)          | 1   |
| &emsp;[3.27 拼音导航](#chapter-three-twenty-seven)          | 1   |
| [四 网友补充](#chatper-four)                                                             |     |
| &emsp;[4.1 文件夹读取报错](#chapter-four-one)                                    | 1   |
| &emsp;[4.2 textarea问题多多](#chapter-four-two)                                  | 1   |
